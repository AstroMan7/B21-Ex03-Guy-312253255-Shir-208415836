...
namespace Ex03.GarageLogic
{
	public class Wheel
	{
		...
		private float m_MaximalAirPressure; //change to readonly?
		...
		// Add air to CurrentAirPressure, throws exception if there if out of ranger
		public void InflateWheel(float i_AirPressure)
		{
			if (m_CurrentAirPressure + i_AirPressure > m_MaximalAirPressure || m_CurrentAirPressure + i_AirPressure < 0) //b
			{
